...
class ScanConfig {
  ...
  static ScanConfig decode(Object result) {
    ...
    return ScanConfig(
      ...
      customBaseUrl: result[6] as String?,
      customFrontendUrl: result[7] as String?,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(apiKey, other.apiKey) && _deepEquals(userKey, other.userKey) && _deepEquals(appName, other.appName) && _deepEquals(requestKey, other.requestKey) && _deepEquals(environment, other.environment) && _deepEquals(schemaVersion, other.schemaVersion) && _deepEquals(customBaseUrl, other.customBaseUrl) && _deepEquals(customFrontendUrl, other.customFrontendUrl);
  }
